...
<head>
  ...
  <style>
    ...
    #searchify-inner-saved>.item-result {
...
<body>
  <div class="searchify-main">
    ...
    border-radius: 5px; text-align: left;">
            <p id="current_user"> <b>Username: </b>
    ...
    <div class="searchify-results">
      ...
      <div class="searchify-inner-shell">
        ...
        <div id="sf_res" class="searchify-inner-results">
          ...
          // echo $div;
// window.location.replace("https://cs.csub.edu/~etagaca/3680/project3/index.php");
          if ($tester == "hello") {
            // echo "just hit this";
            header("Refresh:0");
          ...
          //   echo $_COOKIE["search_url"]."hello";
          // echo $tester;
          
          // $url = "https://serpapi.com/search.json?engine=google_jobs&q=SofwareEngineerIntern&uule=Bakerfield&google_domain=google.com&gl=us&api_key=dde068a2fdf01689775d465a9389b58745dcf023d2fa39acb223c7bee31e00cd";
          ...
          if (isset($_POST["queried"])) {
            ...
            // echo "YOUR JUST MADE A SEARCH! <br>";
            // echo $url;
          }
          $curl = curl_init($url);
          ...
          foreach ($data_f as $d) {
            ...
            $text = $d["description"];
            // $temp_desc = str_replace("\'", "\"", $d["description"]);
            $temp_title = $d["title"];
...
<script>
    ...
    for (let button of buttons) {
      ...
      button.addEventListener('click', event => {
        ...
        if (target.id == "right") {
          ...
          // console.log("title: ", target.children[0].innerHTML);
          // console.log("company: ", target.children[1].innerHTML);
          // console.log("location: ", target.children[2].innerHTML);
          // console.log("thumbnail: ", target.children[3].innerHTML);
          // // console.log("description: ", target.children[4].innerHTML);
          // console.log("schedule: ", target.children[5].innerHTML);
          // console.log("posted at: ", target.children[6].innerHTML);
          // console.log("link : ", target.children[7].innerHTML);
          console.log("Our parser : ", JSON.parse(target.children[8].innerHTML));
  ...
  function onl() {
    ...
    console.log(jsond_decoded["job_type"]);
  ...
  function clickMe(event) {
    ...
    // console.log("Our parser : ", testt);

    testt = testt;
    // testt = testt.replace(/\s/g, '');
    // document.getElementById('dummy_div').innerHTML = res;
    console.log("You have clicked your button", testt);
    // var http = new XMLHttpRequest();
    // http.open("POST", "https://cs.csub.edu/~etagaca/3680/project3/save.php", true);
    // http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    // var params = "save" + testt; // probably use document.getElementById(...).value
    // http.send(params);
  ...
  function remove(event) {
    console.log("Thos the index of the event", event.target.id);
    let element = document.getElementById('data_holder');
    let text = element.innerText;

    let parsed_saved1 = text.split("|");
    console.log("This is parsed: ", parsed_saved1);

    parsed_saved1.splice(event.target.id, 1);
    console.log("This is parsed new: ", parsed_saved1);
  ...
  function show() {
    ...
    $.ajax({
      ...
      // element2.innerHTML = "Hllooooooosdfdsf";
      let parsed_saved = text.split("|");

      console.log(parsed_saved);
      // console.log("hello",parsed_saved[0],"This is parsed0");
