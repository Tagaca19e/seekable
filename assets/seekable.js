    ...
    button.addEventListener('click', (event) => {
      ...
      if (target.id == 'right') {
        ...
        document.getElementById('description').innerHTML =
          '<b>Info: </b> <br>' + target.children[4].innerHTML
        document.getElementById('company').innerHTML =
          '<b>Company: </b> ' + target.children[1].innerHTML
        document.getElementById('what_type').innerHTML =
          '<b>Type: </b> ' + target.children[5].innerHTML
...
function onl() {
  ...
  document.getElementById('current_industry').innerHTML =
    '<b>Industry:</b> <br>' + jsond_decoded['industry']
  document.getElementById('current_job_type').innerHTML =
    '<b>Job type:</b> <br>' + jsond_decoded['job_type']
  document.getElementById('current_location').innerHTML =
    '<b>Location:</b> ' + temp_location
  ...
  $.ajax({
    ...
    for (let i = 0; parsed_saved.length; i++) {
      ...
      if (i !== 0) {
        ...
        let temp_div =
          "<div class='item-result'><div style='text-align: end; opacity: 0.5;'><a id='" +
          i +
          "' onclick='remove(event)'> remove </a></div><img style='border-radius: 5px;' src='" +
          sav_thumbnail +
