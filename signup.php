...
<form  method="POST" action="<?= $_SERVER["PHP_SELF"] ?>">
    ...
    <p> Already have an account? <a href="https://cs.csub.edu/~etagaca/jobscout/index.php?flogin=true"> Log in </a></p> 
...
<form  method="POST" action="<?= $_SERVER["PHP_SELF"] ?>">
    ...
    <!-- <input id="text" type="text" name="password" placeholder="Enter Password"> -->
...
<!-- 
    ...
    grab 4 wanted industries, type of job they are looking (Intern, full time, part time)
     for and their major(jsut for fun*), location (accurate results) -->

    <div id="div1">
    <input class="info" type="checkbox" name="selection" value="Software Engineering"> Software Engineering <br>
    <input class="info" type="checkbox" name="selection" value="Back end Developer"> Back end Developer <br>
    <input class="info" type="checkbox" name="selection" value="Front end Developer"> Front end Developer <br>
    <input class="info" type="checkbox" name="selection" value="Full-Stack Engineer"> Full-Stack Engineer <br>
    ...
    <!-- <input type="button" name="password" placeholder="Enter Password"> -->
...
function submit() {
    ...
    console.log("This is submit: ", document.getElementById('login'));
...
$(document).ready(function() {
  $(window).keydown(function(event){
    if(event.keyCode == 13) {
      ...
      if (event.target.name == "selection" || event.target.name == "username" || event.target.name == "password" || event.target.name == "country" || event.target.name == "city") {
      ...
      console.log(event.target.name, global_step);
      return true;
    } 
  });
});
